...
var DesktopNavbar = dynamic__default.default(() => import('./desktop-navbar-5PBCED3F.cjs'));
var MobileNavbar = dynamic__default.default(() => import('./mobile-navbar.client-JQVTETPJ.cjs'));
function Navbar({
  locale,
  items,
  cta,
