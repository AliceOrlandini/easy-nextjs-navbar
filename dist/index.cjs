...
var DesktopNavbar = dynamic__default.default(() => import('./desktop-navbar-IY3BFHXP.cjs'));
var MobileNavbar = dynamic__default.default(() => import('./mobile-navbar.client-5GYVB7EO.cjs'));
function Navbar({
  locale,
  items,
  cta,
...
exports.FLAG_EN = FLAG_EN;
exports.FLAG_IT = FLAG_IT;
